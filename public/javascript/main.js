        ...
        $(window).on('load resize', function() {
            ...
            if ( currMenuType !== menuType ) {
                ...
                if ( currMenuType === 'mobile' ) {
                    ...
                    var logomobileMenu = $('#mainnav-mobi').find('ul.menu >li').first().before('<li id="logo" class="logo-mobi"><a href="index.html"><img src="images/logo/Mobile-Logo.png" alt="images" data-width="122" data-height="34" data-retina="images/logo/Mobile-Logo.png"></a></li>');
